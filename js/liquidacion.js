...
function generarAcuerdo() {
  ...
  // Contenedor principal sin títulos repetidos e iniciando directamente con el texto
  const html = `
<div style="text-align: justify; text-justify: inter-word; word-break: break-word; overflow-wrap: break-word; line-height: 1.5; color: var(--color-text); font-size: 13.5px; padding: 5px 15px;">
  ...
  <!-- FIN DE PÁGINA 1. El siguiente contenido iniciará de forma limpia en la Página 2 -->
