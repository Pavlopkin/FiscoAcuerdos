...
function generarAcuerdo() {
  ...
  // Contenedor principal con estilos de justificación limpia para evitar cortes incorrectos (como se ve en image_ef85c7.png)
  const html = `
<div style="text-align: justify; text-justify: inter-word; word-break: break-word; overflow-wrap: break-word; line-height: 1.6; color: var(--color-text); font-size: 14px; padding: 10px;">
  ...
  <p style="break-after: page; page-break-after: always; margin-bottom: 0;"><strong>SEGUNDA:</strong> Las partes acuerdan fijar los honorarios del letrado apoderada/o del Fisco de la Provincia de Buenos Aires, en la suma total de <strong>${fhonoL} (${fhono})</strong> pactados de conformidad a las resoluciones dictadas al efecto, las cuales LA DEMANDADA declara conocer y consiente. Asimismo, las partes convienen que dicho monto será cancelado por LA DEMANDADA en UN PAGO.-</p>
  
  <!-- Salto de página forzado en la impresión. Las cláusulas siguientes inician en la Página 2 -->

  <p style="margin-top: 0;"><strong>TERCERA:</strong> En consecuencia, LA DEMANDADA asume e integra, las siguientes sumas:<br>
