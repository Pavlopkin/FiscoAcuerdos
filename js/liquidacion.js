...
<div style="text-align: justify; text-justify: inter-word; word-break: break-word; overflow-wrap: break-word; line-height: 1.5; color: var(--color-text); font-size: 13.5px; padding: 5px 15px;">
  ...
  <p style="margin-top: 0; margin-bottom: 8px;"><strong>SEGUNDA:</strong> Las partes acuerdan fijar los honorarios del letrado apoderada/o del Fisco de la Provincia de Buenos Aires, en la suma total de <strong>${fhonoL} (${fhono})</strong> pactados de conformidad a las resoluciones dictadas al efecto, las cuales LA DEMANDADA declara conocer y consiente. Asimismo, las partes convienen que dicho monto será cancelado por LA DEMANDADA in UN PAGO.-</p>

  <p style="margin-top: 0; margin-bottom: 8px;"><strong>TERCERA:</strong> En consecuencia, LA DEMANDADA asume e integra, las siguientes sumas:<br>
