...
5) <strong>$ ............</strong> en concepto de Servicios Registrales;<br>
6) <strong>${fgastos}</strong> en concepto de gastos generales.</p>

<p>Se deja constancia que el demandado asume la responsabilidad de cancelar cualquier saldo que se pueda adeudar por diferencias a su cargo. Los gastos causídicos pactados en el presente corresponden a la actividad procesal desarrollada por el/la Apoderada/o hasta la fecha del presente, pudiendo modificarse dicho concepto en caso de incumplimiento del acuerdo.</p>

<p><strong>Cuarta.</strong> LA DEMANDADA regularizará el importe adeudado acogiéndose al plan de pago EN CUOTAS A LAS QUE PUEDA ACCEDER VÍA WEB NO PRESENCIAL EN EL SITIO DE ARBA dentro de los cinco (5) días corridos a partir de la fecha de celebración del acuerdo, por el importe que le liquide la ARBA. En caso de no poder regularizar la deuda en la Web de ARBA, deberá hacerlo presencialmente dentro de los primeros treinta (30) días luego de reanudada la atención presencial, con un máximo de 90 días a partir de la fecha. Asume igualmente la obligación de acreditar ante el/la apoderada/o el efectivo acogimiento dentro de los dos (2) días hábiles posteriores a su ingreso en ARBA, con lo que quedará perfeccionado el presente acuerdo. Se deja constancia que ante el incumplimiento del plan de pago que se acuerde con ARBA, el Fisco queda facultado para: a) ejecutar la totalidad del crédito consignado en el título de apremio; b) iniciar un nuevo juicio fundado en el título ejecutivo que emita la autoridad de aplicación.</p>

<p>En prueba de conformidad, se firman tres ejemplares de un mismo tenor y a un solo efecto, recibiendo cada parte el suyo y el restante para acompañar al expediente judicial por parte del/la apoderada/o, pudiendo cualquiera de las partes solicitar su homologación judicial si fuere menester.</p>
`;
